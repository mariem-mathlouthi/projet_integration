    ...
    <section id="content">
      ...
      <div class="col-span-9 mt-24 mr-12">
        ...
        <div class="overflow-x-auto">
          ...
          <div class="overflow-x-auto">
            <table
              class="min-w-full divide-y divide-gray-200 font-[sans-serif]"
            >
              ...
              >
                <tr>
                  <td class="px-6 py-4 text-sm text-[#333]">John Doe</td>
                  <td class="px-6 py-4 text-sm text-[#333]">
                    john@example.com
                  </td>
                  <td class="px-6 py-4 text-sm text-[#333]">Accepte</td>

                  <td class="px-6 py-4 text-sm text-[#333]">2022-05-15</td>
                  <td class="px-6 py-4 text-sm text-[#333]">
                    Développement Web
                  </td>
                  <td class="px-6 py-4 text-sm text-[#333]">
                    <button class="text-green-500 hover:text-green-700 mr-4">
                      <router-link to="/DetailOffreAdmin">Details</router-link>
                    </button>
          ...
          <button class="text-red-500 hover:text-red-700">Delete</button>-->
                ...
                <tr>
                  <td class="px-6 py-4 text-sm text-[#333]">Jane Smith</td>
                  <td class="px-6 py-4 text-sm text-[#333]">
                    jane@example.com
                  </td>
                  <td class="px-6 py-4 text-sm text-[#333]">Refuse</td>
                  <td class="px-6 py-4 text-sm text-[#333]">2022-07-20</td>
                  <td class="px-6 py-4 text-sm text-[#333]">
                    Développement Web
                  </td>
                  <td class="px-6 py-4 text-sm text-[#333]">
          ...
          <button class="text-red-500 hover:text-red-700">Delete</button>-->
                ...
                <tr>
                  <td class="px-6 py-4 text-sm text-[#333]">Alen doe</td>
                  <td class="px-6 py-4 text-sm text-[#333]">
                    alen@example.com
                  </td>
                  <td class="px-6 py-4 text-sm text-[#333]">En Attente</td>
                  <td class="px-6 py-4 text-sm text-[#333]">2022-07-21</td>
                  <td class="px-6 py-4 text-sm text-[#333]">
                    Développement Web
                  </td>
                  <td class="px-6 py-4 text-sm text-[#333]">
